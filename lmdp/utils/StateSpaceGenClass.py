...
class StateSpaceGen:
    ...
    def __next__(self):
        ...
        while self.curr_variable >= 0 and self.generators[self.svars[self.curr_variable]] > self.state_variables[self.svars[self.curr_variable]][1]:
            self.generators[self.svars[self.curr_variable]] = self.state_variables[self.svars[self.curr_variable]][0] # restart variable
