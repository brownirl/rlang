# import unittest
# from grounding.internals import Primitive
# import numpy as np
#
...
#
#         # bp3 = Primitive([[1, 0], [0, 0]])
#         # bp4 = Primitive(0)
#         # # print(Primitive([[1, 0], [0, 0]]) == Primitive(0))
#         # print(bp4 == bp3)
#         # self.assertFalse((Primitive([[1, 0], [0, 0]]) == Primitive(0)).all())
#         # self.assertFalse(Primitive(0) == (Primitive([[1, 0], [0, 0]])).all())
#
