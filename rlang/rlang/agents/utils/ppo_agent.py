...
def parse_args(beta=0.75, name="", seed=0, output_dir='policy_pg_1', env="CartPole-v0", lr=3e-4, steps=10 ** 5,
               render=False, demo=False):
...
def train_agent_ppo(vf, policy, anneal=False, obs_normalizer=None, args=None, beta=0.75, name="", seed=0,
                    output_dir='policy_pg_1', env="CartPole-v0", lr=3e-4, steps=10 ** 5, render=False, demo=False):
