...
def parse_args(seed, output_dir, steps, lr, demo, env="CartPole-v0"):
...
def train_reinforce(model, anneal=False, beta=0.75, name="", seed=0, output_dir='policy_pg_1', lr=1e-3, steps=10 ** 5, demo=False, env='CartPole-v0'):

    args = parse_args(seed, output_dir, steps, lr, demo, env)
