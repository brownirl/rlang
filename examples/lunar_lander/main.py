...
from examples.utils.control_sharing import ControlSharingPolicy, beta_scheduler, linear_scheduler
from examples.utils.ppo_agent import train_agent_ppo
from examples.utils.supervised_init import supervised_init, evaluate_policy
from examples.utils.product_policy import ProductPolicy
...
def rlang_experiment():
    ...
    knowledge = parse_file(args.rlang)
